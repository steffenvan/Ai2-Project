...
for filename in os.listdir(xml_path) :
    if filename.endswith(".xml") and (filename.startswith("W") == 0) and (filename.startswith("P") == 0) and (filename.startswith("D") == 0) and (filename.startswith("E") == 0) and (filename.startswith("S") == 0):
